...
import { idlFactory } from './rbac.did.js';
export { idlFactory } from './rbac.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.RBAC_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./rbac.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the rbac canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./rbac.did.js")._SERVICE>}
 */
export const rbac = createActor(canisterId);
